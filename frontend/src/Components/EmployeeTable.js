...
function EmployeeTable({ employees, pagination, fetchEmployees, handleUpdateEmployee }) {
    const headers = ['Name', 'Email', 'Mobile No', 'Cousre', 'Actions'];
    ...
    // Table row rendering for each employee
    ...
    // Rendering pagination buttons dynamically
